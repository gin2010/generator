...
class Email_GZ(Model):
    data_id = ("data_id", "int")
    data_sort = ("data_sort", "varchar(255)")
    data_desc = ("data_desc", "varchar(255)")
    data_key =  ("email",'varchar(255)')


class NSRSBH_GZ(Model):
    data_id = ("data_id", "int")
    data_sort = ("data_sort", "varchar(255)")
    data_desc = ("data_desc", "varchar(255)")
    nsrsbh = ("nsrsbh",'varchar(255)')
    dkbz = ("dkbz",'char(1)')


class Interface_FPQZ(Model):
    '''
    用于将数据库值转换为接口中的值
    ...
    mx_slv = ("sl", "none")
    mx_hsbz = ("hsbz", "none")
    mx_yhzcbs = ("yhzcbs", "none")
    mx_lslbs = ("lslbs", "none")
    mx_zzstsgl = ("zzstsgl", "none")
    mx_kce = ("kce", "none")
    mx_spbm = ("spbm", "none")
